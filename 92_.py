...
# ===============================
    ...
    pca_df["Risk Level"] = df_clustered["risk_level"].values
    pca_df["Cluster"] = df_clustered["cluster"].values
    pca_df["Heart Attack"] = df_clustered["heart_attack"].values
    ...
    fig = px.scatter(
        ...
        color="Risk Level",
        symbol="Cluster",
        hover_data=["Heart Attack"],
        title="Visualisasi Klaster Risiko Serangan Jantung (KMeans + PCA)",
        color_discrete_map={
            "Rendah": "green",
            "Sedang": "orange",
            "Tinggi": "red"
    ...
    fig.update_layout(legend_title_text="Tingkat Risiko")
